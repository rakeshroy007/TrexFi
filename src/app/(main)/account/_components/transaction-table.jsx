...
const TransactionTable = ({ transactions }) => {
    ...
    const handleSelect = (transactionId) => { 
        setSelectedIds(current => current.includes(transactionId) ? current.filter(item => item!=transactionId) : [...current, transactionId])
    }
    ...
    const totalPages = Math.ceil(filteredAndSortedTransactions.length / maxVisiblePages)
