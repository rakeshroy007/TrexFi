...
const AccountChart = ({ transactions }) => {
  ...
  const filteredData = useMemo(() => {
    ...
    /*   Sample example--> When nothing inside acc... 
      {
        'Nov 19': { date: 'Nov 19', income: 0, expense: 0 },
        'Jan 10': { date: 'Jan 10', income: 0, expense: 0 }
      }
    */
          ...
          <div className='h-[300px]'>
            ...
            <ResponsiveContainer width="100%" height="100%">
              <BarChart
                ...
                <Bar 
                 dataKey="income" 
                 name="Income"           // This name will be shown in 'Legend' section...
                 fill="#22c55e"
                 radius={[4, 4, 0, 0]}
                 />
                <Bar 
                 dataKey="expense" 
                 name="Expense"              // This name will be shown in 'Legend' section...
                 fill="#ef4444" 
                 radius={[4, 4, 0, 0]} 
                  />
              </BarChart>
