  ...
  return (
    <form className='space-y-6' onSubmit={handleSubmit(onSubmitt)}>
      ...
      <div className='grid gap-6 md:grid-cols-2'>
        <div className='space-y-2'>
          ...
          <Input
            ...
            step="0.01"
            placeholder="0.00"
            {...register("amount")}      // Registers this field with a form library (like React Hook Form)
            />
      ...
      <div className='space-y-2'>
        ...
        <Input placeholder="Enter description" {...register("description")} autoComplete="off"  />
        {
          errors.description && (
